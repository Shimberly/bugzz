    ...
    create() {
        ...
        switch (this.statusGame) {
            ...
            this.add.text(this.sys.game.canvas.width / 2 + 20, 190, 'YOU SURVIVE', styleText).setOrigin(0.5);*/
                this.text = this.add.image(this.sys.game.canvas.width / 2, 400, 'txtwin');
            ...
            case 2: //LOSE
                ...
                this.text = this.add.image(this.sys.game.canvas.width / 2, 400, 'txtlose');
                this.gameSound = this.sound.add('gameoversound');
                this.gameSound.play();
                break;
            default:
                this.text = this.add.image(this.sys.game.canvas.width / 2, 400, 'txtstart');
                break;
